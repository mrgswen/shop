...
function checkForm(){
	  ...
	  var password=$("#password").val().trim();
	   ...
	   var checkPhone=$("#checkPhone").text();
	   if(userName==''||password==''||rePassword==''||email==''){
		  // alert("kong");
		   return false;
	   }else if(confirmPasswordText==""&&checkPhone==""){
		   alert("zhengchang");
		   return true;
	   }else{
		  // alert("hah");
	...
	$(function() {   
				$("#userName").keyup(function(){
						...
						$("#checkName").html(
							...
							$.ajax({
								...
								success:function(data){
									if (data == 1) {
										$("#checkName").html("<font color='red'>用户名已经存在！</font>");
										
										
									} else  {
										$("#checkName").html("<font color='green'>用户名可用！</font>");						
									}
								}
							})
						}
                    ...
                    $("#password").keyup(function(){
                    	var password =$("#password").val().trim();
                    	var reg=/^(\w){6,10}$/;//校验密码：只能输入6-10个字母、数字、下划线
						if (password == null || password == '') {
                    	   ...
                    	   $("#checkPassword").html(
							"<font color='red'>只能输入6-10个字母、数字、下划线</font>");  
                       }else{
                    	   alert(password);
                    	   $("#checkPassword").html(""); 
                       }
		...
		<div class="span24">
			<div class="wrap">
				<div class="main clearfix">
					...
					<form id="registerForm" method="post" action="${pageContext.request.contextPath}/userRegister" 
							...
							<tbody>
								<tr>
									...
									<td><input type="text" id="userName" name="userName"
										...
										class="requiredField">*</span><span id="checkName"
								...
								<tr>
									...
									<td><input type="password" id="password" name="password"
										class="text" maxlength="20"><span
										class="requiredField">*</span><span id="checkPassword"
										style="padding-left: 10px;"></span></td>
								</tr>
								<tr>
									<th>确认密码:</th>
									<td><input type="password" id="rePassword"
										...
										><span
										class="requiredField">*</span><span id="confirmPassword"
										style="padding-left: 10px;"></span></td>
								</tr>
								<tr>
									<th>E-mail:</th>
									<td><input type="text" id="email" name="email"
										...
										class="requiredField">*</span><span id="checkEmail"></span></td>
								</tr>
								...
								<tr>
									<th>生日:</th>
									<td><input type="text" id="datepicker"  name="birth" class="text" /></td>
								</tr>
								...
								<tr>
									<th>电话:</th>
									<td><input type="text" name="phone" id="phone" class="text"
										maxlength="200" /><span id="checkPhone"></span></td>
								</tr>
								<tr>
									<th>&nbsp;</th>
									<td><input id="submit" type="submit" class="submit"  value="同意以下协议并注册">
									</td>
								</tr>
								<tr>
									<th>&nbsp;</th>
